...
urlpatterns = [
    ...
    path('update-employee-profile/<uuid:employee_id>/', views.update_employee_profile, name='update_employee_profile'), # Agregado
    ...
    # Panel web
    path('facial-web/', views.facial_attendance_page, name='facial_attendance_page'),
